                            ...
                            <div class="col d-flex justify-content-center">
                                <ul class="nav nav-pills nav-fill">
                                    <li class="nav-item" style="padding-right:5px">
                                        <a class="nav-link active" id="user-tab" style="padding:5px 10px" data-toggle="pill" href="{{ route('user.login') }}">Peminjam</a>
                                    </li>
                                    <li class="nav-item" style="padding-left:5px">
                                        <a class="nav-link" id="admin-tab" style="padding:5px 10px" data-toggle="pill" href="{{ route('admin.login') }}">Admin</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
