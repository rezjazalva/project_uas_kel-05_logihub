...
<head>
    ...
    <link href="assets/css/list-room.css" rel="stylesheet">
                ...
                <div class="sidebar bg-primary">
                    ...
                    <div class="menu row">
                        ...
                        <ul>
                            ...
                            <!-- Daftar Ruang -->
                            <li>
                                <a href="{{route('admin.daftar-ruang')}}" class="nav-link scrollto active">
                                        ...
                                        <div class="chart-cont col">
                                            <div class="container-chart">
                                                ...
                                                <div class="row" style="padding: 15px 20px;">
                                                    <div class="col-12 d-flex justify-content-between align-items-center">
                                                        <h3>Tabel Daftar Ruang</h3>
                                                        <div class="button-crud d-flex gap-2">
                                                            <a href="" class="create"><i class="bi bi-plus-square"></i>Tambah</a>
                                                        </div>
