...
<head>
    ...
    <link href="assets/css/loan-request.css" rel="stylesheet">
                ...
                <div class="sidebar bg-primary">
                    ...
                    <div class="menu row">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="{{route('admin.permohonan')}}" class="nav-link scrollto active">
                            ...
                            <div class="dash-head">
                                <div class="dash-row row mx-3 g-0 d-flex align-items-center">
                                    ...
                                    <div class="col-12 d-flex justify-content-between align-items-center">
                                        <!-- Title -->
                                        <h3>Permohonan Pinjam</h3>
                                        <!-- Form -->
                                        <form action="{{ route('admin.permohonan') }}" method="GET" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                                                                ...
                                                                <table class="table table-bordered" id="data-table" cellspacing="0" width="100%">
                                                                    <thead>
                                                                        <tr class="text-center">
                                                                            ...
                                                                            <th scope="col" style="width:10%">Jumlah Peminjaman Item</th>
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td class="text-center">{{ $peminjamans->perPage() * ($peminjamans->currentPage() - 1) + $loop->iteration }}</td>
                                                                            <td>{{ $peminjaman->user->name }}</td>
                                                                            <td class="text-center"> {{ $peminjaman->user->no_induk }}</td>
                                                                            <td class="text-center">{{ $peminjaman->kode_item }}</td>
                                                                            ...
                                                                            <td class="text-center">
                                                                                ...
                                                                                <a href="{{ route('admin.permohonan.edit', ['id' => $peminjaman->id]) }}" class="update"><i class="bi bi-pencil-square"></i>Sunting</a>

                                                                                <a href="{{ route('admin.permohonan.destroy', ['peminjaman' => $peminjaman]) }}" class="delete" onclick="event.preventDefault(); if (confirm('Apakah Anda yakin ingin menghapus item ini?')) document.getElementById('delete-form-{{ $peminjaman->id }}').submit();">
                                                                                    <i class="bi bi-x-square"></i>Hapus
                                                                                </a>
                                                                                <form id="delete-form-{{ $peminjaman->id }}" action="{{ route('admin.permohonan.destroy', ['peminjaman' => $peminjaman]) }}" method="POST" style="display: none;">
                                                                                    @csrf
                                                                                    @method('DELETE')
                                                                                </form>
                                                                            </td>
