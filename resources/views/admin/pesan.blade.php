                ...
                <div class="sidebar bg-primary">
                    ...
                    <div class="menu row">
                        ...
                        <ul>
                            ...
                            <!-- Pesan -->
                            <li class="last">
                                <a href="{{route('admin.pesan')}}" class="nav-link scrollto active">
                                    ...
                                    <div class="col-12 d-flex justify-content-between align-items-center">
                                        ...
                                        <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                                            <div class="input-group">
                                                <input type="text" class="form-control border-0 small" id="searchInput" placeholder="Pencarian" aria-label="Search" aria-describedby="basic-addon2">
                                                <div class="input-group-append">
                                                    <button class="btn" type="button" onclick="searchData()">
                                                ...
                                                <div class="row" style="padding: 15px 20px;">
                                                    <div class="col-12 d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div class="button-crud d-flex gap-2">
                                                            <a href="" class="delete"><i class="bi bi-x-square"></i>Hapus</a>
                                                        </div>
                                                                ...
                                                                <table class="table table-bordered" id="data-table" cellspacing="0" width="100%">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td class="text-center">
                                                                                <label class="crud-checkbox-label">
                                                                                    <input type="checkbox" class="crud-checkbox" onclick="handleCheckboxClick(this)">
                                                                                    <span class="crud-checkbox-label"></span>
                                                                                </label>
                                                                            </td>
                                                                            <td class="text-center">MS001</th>
                                                                            <td>Megantara Syafa</td>
                                                                            <td>megantara.syafa.20@student.is.ittelkom-sby.ac.id</td>
                                                                            <td>Penyampaian Keluhan Layanan</td>
                                                                            <td>Proses konfirmasi status berlangsung cukup lama.</td>
                                                                        </tr>
                                                                        ...
                                                                        <tr class="second-tr">
                                                                            ...
                                                                            <td class="text-center">MS002</th>
                                                                            <td>Ahmad Zhilal Fanani</td>
                                                                            <td>ahmad.zhilal.20@student.is.ittelkom-sby.ac.id</td>
                                                                            <td>Permintaan Pengadaan Item</td>
                                                                            <td>Bagaimana langkah untuk mengajukan permintaan pengadaan item baru ?</td>
                                                                        </tr>
